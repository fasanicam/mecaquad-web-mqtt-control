            ...
            <div className="flex gap-8 h-48">
                ...
                <div className="flex flex-col items-center h-full gap-2">
                    <input
                        ...
                        disabled={disabled}
                        className="h-full w-4 appearance-none rounded-full bg-white/20 outline-none  [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-6 [&::-webkit-slider-thumb]:w-6 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-blue-500 cursor-pointer"
                        style={{
                ...
                <div className="flex flex-col items-center h-full gap-2">
                    <input
                        ...
                        disabled={disabled}
                        className="h-full w-4 appearance-none rounded-full bg-white/20 outline-none [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-6 [&::-webkit-slider-thumb]:w-6 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-indigo-500 cursor-pointer"
                        style={{
                            writingMode: 'vertical-lr',
                            direction: 'rtl',
